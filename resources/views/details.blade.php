                        ...
                        <div class="col-md-6">
                            <div class="cloth-details-size">
                                ...
                                <div class="product-buttons">
                                    <a href="javascript:void(0)" onclick="addToWishlist();" class="btn btn-solid">
                                    ...
                                    <a href="javascript:void(0)" onclick="event.preventDefault();document.getElementById('addtocart').submit();"
                                     id="cartEffect" class="btn btn-solid hover-solid btn-animation">
                                        ...
                                        <a href="javascript:void(0)" onclick="addToCart();" id="cartEffect" class="btn btn-solid hover-solid btn-animation">
                                            <i class="fa fa-shopping-cart"></i>
                                            <span>Add To Cart</span>
                                        </a>
