...
<section class="pt-0 poster-section">
        <div class="poster-image slider-for custome-arrow classic-arrow">
            <div>
                <img src="assets/images/image-pc/keyboard-3-Photoroom.png-Photoroom.png" width="650" height="200" class="img-fluid blur-up lazyload" alt="">
            </div>
            <div>
        ...
        <div class="slider-nav image-show">
            <div>
                <div class="poster-img">
                    <img src="assets/images/image-pc/keyboard-3.png" width="120" class="img-fluid blur-up lazyload" alt="">
        ...
        <div class="left-side-contain">
            <div class="banner-left">
                ...
                <h1>New Latest <span>Keyboards</span></h1>
                <p>BUY TWO GET ONE <span class="theme-color">FREE</span></p>
                <h2>MAD499.00 <span class="theme-color"><del>MAD599.00</del></span></h2>
                    ...
                    <div class="collection-banner p-bottom p-center text-center">
                        ...
                        <a href="shop-left-sidebar.html" class="contain-banner">
                            <div class="banner-content with-big">
                                <h2 class="mb-2">USB Flash Drive</h2>
